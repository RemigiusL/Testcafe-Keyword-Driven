...
- `Slack Appender for log4js-node` Sends log events to a [slack](https://slack.com) channel. This is an optional appender for use with [log4js](https://log4js-node.github.io/log4js-node/).[->](https://api.slack.com/methods/files.upload)
